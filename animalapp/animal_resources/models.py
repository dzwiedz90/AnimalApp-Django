...
from resources.models import DewormingRemedy, TreatmentAndDisease, VetClinic, RemedyForTicks, Vaccine


# TODO add a validation of date_died and similar dates in other models so the date_died cannot be earlier or equal to
#  date_born
